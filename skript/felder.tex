...
\begin{center}
	\ibox{\includegraphics[scale=0.40]{img/bsp1_coord.png}}
\end{center}
\iend
\newpage
\bsp{Lösung}{}
...
\begin{center}
	\ibox{\includegraphics[scale=0.40]{img/sol_1_koord.png}}
\end{center}
...
\definition{Winkelabhängige Basisvektoren}
\beginip
...
\begin{center}
	%TODO FIX
	\ibox{\includegraphics[scale=0.40]{img/ex2_coord.png}}
...
\newpage
	...
	\subsubsection{Karthesische Koordinaten}

	\important{Karthesische Koordinaten} {}
	\beginip
...
\iend
\newpage
\important{Richtung der einzelnen Besisvektoren für beliebige Punkte im Raum: }{}
...
%TODO add points an img
\ibox{\includegraphics[scale=0.4]{img/wegintegral_beg.png}}
