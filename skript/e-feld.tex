...
\begin{enumerate}
	\item Überlege, ob ----- Superpositionsprinzip

	\item Versuche die Symmetrie der Anordnung herauszufinden und entscheide dich für ein Koordinatensystem: \\
	...
	\item Falls Ladungsdichte oder Ladung gegeben, suche Hüllfläche, auf der das Feld Konstant ist.

	\item Verwende $\displaystyle \oiint_A \vec{D} \cdot d\vec{A} = Q \Rightarrow D = \frac{Q_{eff}}{A_{eff}}$
