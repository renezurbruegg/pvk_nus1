...
%----------------------------------------------------------------
					...
					\important{Beispiel}{E-Feld einer Punktladung}
					\beginbsp
					...
					\important{Beispiel}{E-Feld einer Platte}
					\beginbsp
...
$
					...
					\important{Beispiel}{E-Feld eines Kondensators}
					\beginbsp
					...
					\important{Gleichung}{Quellgleichung des elektrischen Flusses}
					...
					\important{Beispiel}{Berechnung des D-Feldes einer Kugel}
					\beginbsp
...
\begin{center}
   ...
   \end{cases}$
	 ...
	 \end{center}
					...
					\important{Gleichung}{Zusammenhang E-Feld und D-Feld}
					\begingl
					\begin{center}
						\formulaBegin
				...
				\begin{itemize}
					...
					\important{Gleichung}{Kapazität eines Plattenkondensators}
					\begingl
