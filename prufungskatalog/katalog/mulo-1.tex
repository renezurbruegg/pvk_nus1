...
\newenvironment{homeworkProblem}[1][Serie 4 - Tipps]{ % Makes a new environment called homeworkProblem which takes 1 argument (custom name) but the default is "Problem #"
...
\newcommand{\hmwkTitle}{Netzwerk und Schaltungen 1 - \"Ubung 4} % Assignment title
...
\item b) Der Zusammenhang zwischen E-Feld un J-Feld ist gegeben als:
\begin{center}
