...
\begin{itemize}
  ...
  \begin{center}
    $50mW \stackrel{!}{=} P_{R_\vartheta} = \frac{ \big( U_e^2 \cdot \frac{1k\Omega}{4k\Omega} \big) }{R_\vartheta}$ \\
    $\rightarrow 200mW = \frac{U_e^2}{R_\vartheta}  $ \\
    $ \rightarrow U_e = \sqrt{200mW \cdot 1 \cdot 10^3 \Omega }  = 14.14V $
  \end{center}
