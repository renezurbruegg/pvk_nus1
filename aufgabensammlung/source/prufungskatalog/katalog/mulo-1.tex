...
\begin{center}
  $R_{AB} = \frac{1}{12 \cdot 10^3 \frac{S}{m} \cdot 3\cdot 10^{-3} m \cdot 2 \pi} \cdot ln(\frac{2 \cdot 10^{-2}}{5 \cdot 10^{-3}}) = 6.13m\Omega$
\end{center}
 c) Wir betrachten beide Fälle (-3mm und +3mm):  \\
 \begin{center}
 +3mm: $\rightarrow R' = \frac{1}{12 \cdot 10^3 \frac{S}{m} \cdot 3\cdot 10^{-3} m \cdot 2 \pi} \cdot ln(\frac{2 \cdot 10^{-2} + 3 \cdot 10^{-3}}{5 \cdot 10^{-3}}) = 6.75m\Omega \rightarrow \Delta R =  |R-R'| = 0.617 m\Omega$\\
 -3mm: $\rightarrow R' = \frac{1}{12 \cdot 10^3 \frac{S}{m} \cdot 3\cdot 10^{-3} m \cdot 2 \pi} \cdot ln(\frac{2 \cdot 10^{-2} - 3 \cdot 10^{-3}}{5 \cdot 10^{-3}}) = 5.41m\Omega \rightarrow \Delta R =  |R-R'| = 0.72 m\Omega$\\
 Daraus Folgt: Maximaler Fehler bei $-3mm$. $R'$ ist dann $5.41m\Omega$ und für den Fehler gilt: $ \Delta R = 0.72 m\Omega$
\end{center}
...
\begin{center}
 ...
 $ F = \frac {\Delta I}{I} = \frac{\Delta I}{U_{AB}/R_{AB}} = |1 - \frac{R_{AB}}{R'_{AB}}| = |1 - \frac{6.13\Omega}{5.41\Omega}| = 13.3\% $
\end{center}
